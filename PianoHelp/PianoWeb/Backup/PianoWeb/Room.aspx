        ...
        <div class="ww">
            ...
            <div class="room">
                ...
                <div id="div_adornment" class="drl0">
                    ...
                    <div class="t"><label id="adornment_name">aaaaaaaaaaa</label><br/>
                        <input id="btnOption" type="button" onclick="on_option()" class="but"/></div>
                    
                    <div  class="drl">
                        <div class="l"><a href="#" onclick="goto_data(1)">
                            <img src="images/drl01.png"  width="24" height="44"></a></div>
                        <div class="r"><a href="#" onclick="goto_data(2)"><img src="images/drl02.png"  width="24" height="44"></a></div>
                    </div>
