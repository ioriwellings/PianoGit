...
<script language="javascript">
    ...
    function OnPlayers() {
        ...
        var url1 = "./WorkShow.aspx?listen=yes&userName=" + user + "&opusID=" + opusID;
          ...
          <div class="left">
	        ...
	        <div class="workshow3" id="other1">
              <div class="workshow3d">
                ...
                <li><asp:ImageButton ID="btnDel" runat="server" src="images/workshow3d-04.png" 
                        width="70" height="70" onclick="btnDel_Click" onclientclick="return delete_configure()"/>                                         <br />删除</li>
                
                <li><a href="#" onclick="postToWb()"><img src="images/workshow3d-03.png"  width="70" height="70">
                        <br />分享</a></li>
